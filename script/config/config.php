...
$config["script_url"] = "https://chipdien.net/vee/";
...
$config["database"] = "center_vee";

//Set the username for database access

$config["username"] = "center_vee";

//Set the pwd for the database user

$config["password"] = "ijMrpzmSeA5YfbjE";
...
$config["purchase_code"] = "d06d1902-8e56-4c09-97cd-6cbbe786bd8e";
